...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="FeeStructure.jsp" class="nav-link">Fee Structure</a></li>
    ...
    <div class="hero-wrap hero-wrap-2" style="background-image: url('image1/5.jpg'); background-attachment:fixed;">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex ftco-animate">
    				<div class="img img-about align-self-stretch" style="background-image: url(images1/bg_3.jpg); width: 100%;"></div>
    			</div>
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section img" style="background-image: url(image1/bg_3.jpg.jpg); background-attachment:fixed;">
    	<div class="overlay"></div>
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              <h2><a class="navbar-brand" href="home.jsp"><i class="flaticon-university"></i>Genius <br><small>University</small></a></h2>
          ...
          <div class="col-md-2">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Fee Structure</a></li>
